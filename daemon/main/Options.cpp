...
static const char* OPTION_USETEMPUNPACKFOLDER	= "UseTempUnpackFolder";
...
void Options::InitDefaults()
{
	...
	SetOption(OPTION_USETEMPUNPACKFOLDER, "yes");
...
void Options::InitOptions()
{
	...
	m_useTempUnpackFolder	= (bool)ParseEnumValue(OPTION_USETEMPUNPACKFOLDER, BoolCount, BoolNames, BoolValues);
